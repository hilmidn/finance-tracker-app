    ...
    <div className="min-h-dvh flex flex-col items-center justify-center px-6 bg-gradient-to-b from-indigo-950 via-indigo-900 to-indigo-800">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center rounded-2xl bg-white/10 backdrop-blur mb-5 border border-white/20">
            <img className="rounded-2xl" src="/login-logo.png" />
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {error && (
            <p className="text-sm text-red-300 bg-red-900/30 rounded-xl px-4 py-2.5 text-center">
              {error}
            </p>
          )}
