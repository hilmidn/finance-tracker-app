...
export default function WalletsPage({ userId }) {
  ...
  const formatIdr = (n) => (n !== undefined && n !== null ? n.toLocaleString('id-ID') : '0')
          ...
          <div className="bg-white w-full max-w-lg rounded-t-2xl sm:rounded-2xl p-5 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-lg font-bold text-gray-900">
                {editId ? 'Edit Dompet' : 'Tambah Dompet'}
              </h2>
              <button onClick={() => { setShowAdd(false); setEditId(null) }} className="p-2 hover:bg-gray-100 rounded-xl transition-colors">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={form.type === 'cash' ? 'Dompet Harian' : form.type === 'bank' ? 'BCA, Mandiri...' : 'GoPay, OVO...'}
                  required
